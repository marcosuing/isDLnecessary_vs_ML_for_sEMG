function [tabla_accuracy] = f_lectura_accuracies(a_knn_RMS,a_knn_MAV,a_knn_VAR,a_svm_RMS,a_svm_MAV,a_svm_VAR,...
    ...
    n_muestras = 18; % Dimensión de cada vector (1x18)
    
    % Preasignación de espacio para la matriz (18 filas x 18 columnas)
    ...
    % 3. Matriz Transpuesta (18 filas/muestras x 18 modelos/columnas)
    ...
    nombre_csv = 'resultados_accuracy_dba_17_sep_2026.csv';
